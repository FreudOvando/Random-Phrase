...
const BtnPhrase = ({ setPhrase, setphoto }) => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute w-36 h-32 -top-8 -left-2 bg-amber-600 rotate-12 transform scale-x-0 group-hover:scale-x-50 transition-transform group-hover:duration-1000 duration-500 origin-left"></span>
